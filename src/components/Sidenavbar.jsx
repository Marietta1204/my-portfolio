...
const Sidenavbar = () => {
  ...
  return (
    <div>
      <AiOutlineMenu className="absolute top-4 right-4 z-[99] md:hidden text-white" onClick={handleNav}/>
      {
       nav ? (
      ...
      <div className="md:block hidden fixed top-[25%] z-10">
        <div className="flex flex-col">
          <a href="#main" className="rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer ease-in hover:scale-110 duration-300">
            <AiOutlineHome size={20}/>
          </a>
          <a href="#work" className="rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer ease-in hover:scale-110 duration-300">
            <GrProjects size={20}/>
          </a>
          <a href="#projects" className="rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer ease-in hover:scale-110 duration-300">
            <AiOutlineProject size={20}/>
          </a>
          <a href="#about" className="rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer ease-in hover:scale-110 duration-300">
            <BsPerson size={20}/>
          </a>
          <a href="#contact" className="rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer ease-in hover:scale-110 duration-300">
            <AiOutlineMail size={20}/>
          </a>
        </div>
      </div>
